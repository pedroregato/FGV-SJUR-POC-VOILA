"""
Verifica processos com Arquivamento Definitivo (codigo TPU 246)
...
PASTA_SAIDA      = Path(r"F:\FGV-SJUR\resultado_arquivamento_definitivo")
...
CODIGO_ALVO = 246
NOME_ALVO   = "Arquivamento Definitivo"
...
def verificar_arquivamento_definitivo(
    ...
    Arquivamento Definitivo (codigo TPU 246) no DataJud.
    ...
    for i, numero in enumerate(pendentes, start=1):
        ...
        try:
            ...
            if resultado["sucesso"]:
                ...
                data_arquivamento = _data_mais_antiga(movs, CODIGO_ALVO)

                info = {
                    "numero_processo":          numero,
                    "encontrado_na_api":        "Sim",
                    "status":                   "ok",
                    "tem_arquivamento_definitivo": "Sim" if data_arquivamento else "Nao",
                    "data_arquivamento_definitivo": data_arquivamento,
                ...
                if data_arquivamento:
                    log.info(f"  Encontrado: {NOME_ALVO} @ {data_arquivamento}")
                else:
                    log.info("  Sem arquivamento definitivo")
                ...
                info = {
                    ...
                    "tem_arquivamento_definitivo": "N/A",
                    "data_arquivamento_definitivo": "",
                }
            ...
            info = {
                ...
                "status":                      str(exc),
                "tem_arquivamento_definitivo": "Erro",
                "data_arquivamento_definitivo": "",
            }
    ...
    saida = pasta_saida / f"arquivamento_definitivo_{timestamp}.xlsx"
...
def _exibir_resumo(df: pd.DataFrame, total_entrada: int) -> None:
    ...
    com_arquivamento = (df.get("tem_arquivamento_definitivo") == "Sim").sum()
    ...
    log.info(f"Com Arquivamento Definitivo  : {com_arquivamento}")
    log.info("=" * 52)
...
if __name__ == "__main__":
    verificar_arquivamento_definitivo()
